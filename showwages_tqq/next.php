    ...
    <div id="ztcontent">
    	<div class="box1">
         ...
         <div class="main2 J_main">
            ...
            <form method="post" action="next2.php" id="form1">
            	<input type="hidden" value="0" name="ka" id="J_ka" />
            	<input type="submit" value=""  id="J_submit" style="width:182px; height:52px; margin-left:294px; margin-top:56px; background:url(src/images/182x52.jpg) no-repeat; border:none; cursor:pointer;">
            </form>
         </div>        
  	</div>
    </div>
