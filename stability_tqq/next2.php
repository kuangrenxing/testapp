    	...
    	<div class="box1">
         ...
         <div class="main2">
                 ...
                 <div class="question_content">
                 		<form id="form1" action="next3.php" method="get">
                        	<p><input id="ck5" value="1"  name="chose2" type="radio" /><label for="ck5">&nbsp; A &nbsp; 一个</label></p>
                        	<p><input id="ck6" value="2" name="chose2" type="radio" /><label for="ck6">&nbsp; B &nbsp; 两个</label></p>
                            <p><input id="ck7" value="3"  name="chose2" type="radio" /><label for="ck7">&nbsp; C &nbsp; 三个</label></p>
                            <p><input id="ck8" value="4"  name="chose2" type="radio" /><label for="ck8">&nbsp; D &nbsp; 四个以上</label></p>
                 		</form>
                 </div>
         </div>        
  	</div>
