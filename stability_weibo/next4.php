    	...
    	<div class="box1">
         ...
         <div class="main2">
                 ...
                 <div class="question_content">
                 		<form id="form1" action="next5.php" method="get">
                        	<p><input id="ck13" value="1" name="chose4" type="radio" /><label for="ck13">&nbsp; A &nbsp; 一个</label></p>
                        	<p><input id="ck14" value="2" name="chose4" type="radio" /><label for="ck14">&nbsp; B &nbsp; 两个</label></p>
                            <p><input id="ck15" value="3" name="chose4" type="radio" /><label for="ck15">&nbsp; C &nbsp; 三个</label></p>
                            <p><input id="ck16" value="4" name="chose4" type="radio" /><label for="ck16">&nbsp; D &nbsp; 四个以上</label></p>
                 		</form>
                 </div>
         </div>        
  	</div>
