    	...
    	<div class="box1">
         ...
         <div class="main2">
                 ...
                 <div class="question_content">
                 		<form action="next4.php" method="get">
                        	<p><input id="ck9" name="chose3" type="radio" /><label for="ck9">&nbsp; A &nbsp; 0次</label></p>
                        	<p><input id="ck10" name="chose3" type="radio" /><label for="ck10">&nbsp; B &nbsp; 1~2次</label></p>
                            <p><input id="ck11" name="chose3" type="radio" /><label for="ck11">&nbsp; C &nbsp; 3~4次</label></p>
                            <p><input id="ck12" name="chose3" type="radio" /><label for="ck12">&nbsp; D &nbsp; 5次以上</label></p>
                 		</form>
                 </div>
         </div>        
  	</div>
