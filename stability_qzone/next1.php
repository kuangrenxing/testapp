    	...
    	<div class="box1">
         ...
         <div class="main2">
                 ...
                 <div class="question_content">
                 		<form action="next2.php" method="get">
                        	<p><input id="ck" name="chose1" type="radio" /><label for="ck">&nbsp; A &nbsp; 半小时以内</label></p>
                        	<p><input  id="ck2" name="chose1" type="radio" /><label for="ck2">&nbsp; B &nbsp; 地铁一个小时以内</label></p>
                            <p><input id="ck3" name="chose1" type="radio" /><label for="ck3">&nbsp; C &nbsp; 公交换乘地铁一个小时以内</label></p>
                            <p><input id="ck4" name="chose1" type="radio" /><label for="ck4">&nbsp; D &nbsp; 公交或者地铁一个小时以上</label></p>
                 		</form>
                 </div>
         </div>        
  	</div>
