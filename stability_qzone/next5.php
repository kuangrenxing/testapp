         ...
         <div class="main2">
                 ...
                 <div class="question_content">
                 		<form action="auth.php" method="get">
                        	<p><input id="ck17" name="chose5" type="radio" /><label for="ck17">&nbsp; A &nbsp; 一年以上</label></p>
                        	<p><input id="ck18" name="chose5" type="radio" /><label for="ck18">&nbsp; B &nbsp; 半年</label></p>
                            <p><input id="ck19" name="chose5" type="radio" /><label for="ck19">&nbsp; C &nbsp; 三个月之内</label></p>
                            <p><input id="ck20" name="chose5" type="radio" /><label for="ck20">&nbsp; D &nbsp; 一个月之内</label></p>
                 		</form>
                 </div>
         </div>        
  	</div>
